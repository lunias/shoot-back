package com.ethanaa.shootback.util;
...
import com.ethanaa.shootback.Main;
...
public class ResourceUtil {
	...
	static ResourceBundle resources = ResourceBundle
			.getBundle("com.ethanaa.shootback.text");
	...
	public static URL getLocalWebResource(String htmlFile) {
		return Main.class.getResource("/com/ethanaa/shootback/html/" + htmlFile);
	}
